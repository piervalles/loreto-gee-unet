...
# CON KEEP-ALIVE Y AUTENTICACIÓN GCP
# =============================================================================

# 1. Autenticación y keep-alive (para ejecución desatendida)
from google.colab import auth, output
auth.authenticate_user()
print("✅ Autenticación con Google Cloud completada.")

# Keep-Alive: evita que Colab se duerma (clic virtual cada 60 segundos)
output.eval_js('''
new Promise(resolve => {
  setInterval(() => {

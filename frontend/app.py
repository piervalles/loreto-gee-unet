...
# Cambia a "local" para leer desde tu disco, o a "gcs" para leer de la nube.
# ---------------------------------------------------------------------------
FUENTE_DATOS: str = "local"  # <-- Cambia entre "local" y "gcs"
...
RUTA_GEOJSON_LOCAL: pathlib.Path = (
    _DIR_RAIZ / "backend" / "data" / "Inferencia" / "2023" / "resultado_inferencia_1.geojson"
)
